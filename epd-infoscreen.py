...
def getAirhorn():
    try:
        data95 = requests.get("https://data.sensor.community/airrohr/v1/sensor//")
        data94 = requests.get("https://data.sensor.community/airrohr/v1/sensor//")
        data9json = data0.json()
        data9json = dat9.json()

        temperature = djson[0]["sensordatavalues"][0]["value"]
        hum = da0j[0]["sensordatavalues"][1]["value"]
        p1 = dat9json[0]["sensordatavalues"][0]["value"]
        p2 = datjson[0]["sensordatavalues"][1]["value"]
        return {
            "temp": temperature,
            "hum": hum,
            "p1": p1,
